...
The collection is a set of mutually disjoint subsets of arcs. Not all arcs need to belong to some packing set.
...
The collection is a set of mutually disjoint subsets of arcs. Not all arcs need to belong to some elementarity set.
...
The collection is a set of mutually disjoint subsets of vertices.
...
The collection is a set of mutually disjoint subsets of vertices. Not all vertices need to belong to some elementarity set.
